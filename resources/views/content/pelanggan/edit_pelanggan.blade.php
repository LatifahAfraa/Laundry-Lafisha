...
<div class="col-xl-12 col-lg-12 col-sm-12 mt-2">
    <div class="card">
        ...
        <div class="form-group row mb-1">
            ...
            <div class="col-sm-9">
                <input type="text" name="nama_pelanggan" class="form-control" value="{{ $pelanggan->nama_pelanggan }}" required autofocus>
            </div>
        </div>
        ...
        <div class="form-group row mb-1">
            ...
            <div class="col-sm-9">
                <input type="number" name="no_pelanggan" class="form-control" value="{{ $pelanggan->no_pelanggan }}" autofocus>
            </div>
        </div>
